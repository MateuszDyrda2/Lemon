...
class LEMON_API batch_renderer : public renderer2d
{
    struct vertex
    {
        vec2 position;
    ...
    struct batch
    {
        ...
        void add_quad(const mat4& trans, color col, vec4 texCoords);
  ...
  public:
    ...
    void render_sprite(const color& col, const vec4& texCoords, asset<texture>& tex,
